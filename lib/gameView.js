(function () {
  ...
  //saves score and renders high scores
  GameView.prototype.highScores = function () {
  ...
  var moveCallback = function () {
    ...
    if(key.isPressed("left")) this.game.ship.turn("left");
    if(key.isPressed("right")) this.game.ship.turn("right");
  ...
  //binds firebullet function while game is being played
  GameView.prototype.bindKeyHandlers = function(){
    gameView = this;
    key('space', function(){ gameView.game.ship.fireBullet(); });
  };

  //binds key for restarting the game after game ends
